                ...
                <div key={product.id} className="flex gap-3 bg-gray-50 rounded-xl p-3 border border-gray-100">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-black text-[#ff4d4d]">₼{product.price.toFixed(2)}</span>
                      <button
                        onClick={() => { addToCart(product); toggleWishlist(product); }}
                        className="flex items-center gap-1 text-xs font-semibold bg-[#333E48] hover:bg-[#ff4d4d] text-white px-3 py-1.5 rounded-lg transition-all"
                      >
